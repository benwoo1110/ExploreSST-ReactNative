...
export const conversationsSec2 = {
  ...
  ChangeMakersInnofest: [
    ...
    ["In 2018, the main theme was 'The Elderly Challenge', where students were tasked to work on developing proposals that could lead to a better quality of life for our elderly, both now, and more specifically beyond 2030. But why 2030?", ""],
    ["As the proportion of the elderly population is projected to increase significantly to form a large segment of Singapore’s population, there is an urgent need for possible considerations to be adopted to mitigate the challenges that may crop up.", ""],
