...
export const conversationsSec2 = {
  SSTINC: [
    ...
    "You see, SST Inc replicates a set-up of various companies within a conglomerate. If you’re really good, you can get ‘poached’ by the best companies! Of course, there is a chance to get fired as well. ",
    "This is dependent on a year-end performance review conducted by the teachers. However, we feel that this is best as it helped students to build up competencies such as self-discipline, self-reflection, resilience and perseverance. ",
    ...
    "SST Inc has created many different apps over the years. What impressed me the most was this KK Hospital App, where students worked with KK Women’s and Children’s Hospital to develop the KKH Paediatrics Anaesthesia Handbook App. ",
    "It assists junior doctors in various areas such as administering the right dosage for anaesthesia based on patient profile, example being weight, age.",
  ...
  ISS: [
    ...
    "Their experiment helped establish which type of starchy food is most suitable for patients to consume when they are affected with different types of diseases. I feel that this app will really help the patients in terms of calibrating the right food choices!",
  ...
  ACE: [
    ...
    "That’s not all there is to ACE though. Earlier last year, we initiated the #ACEfooddrive2k18, a food donation drive with the objective to help improve the poverty situation of the beneficiaries from Food From The Heart and some 135 underprivileged elderly families living in the Lengkok Bahru vicinity."
  ],
  ...
  CCA: [
    ...
    "Also as previously mentioned, we also have Scouts as a Uniform Group"
  ],
  ...
  AS: [
    ...
    "The subject of biotechnology is distinct from biology; while biology studies basic processes of living organisms, biotechnology is the application of biology to solve problems and improve lives.",
    "How great is it to use our application of knowledge to better the world?",
  ...
  Fencing: ["This PART MAKES NO FUCKING SENSE RIGHT NOW."],
  ...
  InnoFest: [
    ...
    "In 2018, the main theme was ‘The Elderly Challenge’, where students were tasked to work on developing proposals that could lead to a better quality of life for our elderly, both now, and more specifically beyond 2030.",
    "But why 2030? As the proportion of the elderly population is projected to increase significantly to form a large segment of Singapore’s population, there is an urgent need for possible considerations to be adopted to mitigate the challenges that may crop up.",
